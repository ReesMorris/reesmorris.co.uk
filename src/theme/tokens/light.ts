...
export const lightTokens: ThemeTokens = {
  'blockquote-border-color': staticThemeVar('color-gray-8'),
  ...
  'color-code-background': staticThemeVar('color-gray-9'),
  'color-code-class': staticThemeVar('color-brown-3'),
  'color-code-comment': staticThemeVar('color-gray-4'),
  'color-code-constant': staticThemeVar('color-blue-2'),
  'color-code-function': staticThemeVar('color-purple-4'),
  'color-code-keyword': staticThemeVar('color-red-4'),
  'color-code-string': staticThemeVar('color-blue-3'),
  ...
  'color-text-link': staticThemeVar('color-blue-3'),
  'color-text-link-hover': staticThemeVar('color-blue-2'),
